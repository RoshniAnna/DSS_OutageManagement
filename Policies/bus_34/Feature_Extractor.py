...
class CustomGNN(BaseFeaturesExtractor):
    ...
    def __init__(self,
        ...
        self.full_context_nn = torch.nn.Sequential(*[torch.nn.Linear(42, features_dim), torch.nn.Linear(features_dim, features_dim)])
        self.switch_encoder = torch.nn.Sequential(*[torch.nn.Linear(37, features_dim), torch.nn.Linear(features_dim, features_dim)])
